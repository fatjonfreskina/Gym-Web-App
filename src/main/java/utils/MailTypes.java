...
public class MailTypes {
     ...
     * @method mailForPasswordChanges : When someone request for a password reset
    ...
    public static void mailForTrainerChanged(Person trainee, LectureTimeSlot lectureTimeSlot) throws MessagingException {
        ...
        String emailContent = "Dear " + trainee.getName() + " " + trainee.getSurname() + ",\n" + "\n\n" + "we inform you that the lecture of " + lectureTimeSlot.getCourseName() + " course , in date " + lectureTimeSlot.getDate() + " at " + lectureTimeSlot.getStartTime() + " will be held by " + lectureTimeSlot.getSubstitution() + "\n\nKind regards,\n" + "The Gwa Team";
