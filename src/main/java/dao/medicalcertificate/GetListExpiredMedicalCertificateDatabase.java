    ...
    public List<Person> execute() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                var tmp = new Person(rs.getString("email"), rs.getString("name"), rs.getString("surname"), rs.getString("password"), rs.getString("taxCode"), rs.getDate("birthdate"), rs.getString("telephone"), rs.getString("address"), rs.getString("avatarpath"));
