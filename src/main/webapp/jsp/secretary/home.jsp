            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container text-center">
                        ...
                        <div>
                            <div class="row" style="display: none;" id="modal-div-substitution">
                                <div class="col-sm">
                                    <span class="text-danger">Warning:</span>
                                </div>
                                <div class="col-sm">
                                    <span id="modal-course-substitution"></span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <span id="modal-course-date"></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm">
                                ...
                                <div class="col-sm">
                                    <span id="modal-course-startTime"></span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm">
                                ...
                                <div class="col-sm">
                                    <span id="modal-course-roomName"></span>
                                </div>
                            </div>
                        </div>
